...
public class HMReducerChainLocalPath1 extends Reducer<IntWritable, LongWritable, IntWritable, LongWritable>{
	private LongWritable sumWritable = new LongWritable(10);
	String filename;
	private final static Log LOG = LogFactory.getLog(HMReducerChainLocalPath1.class);
