...
public class HMReducerPath2 extends Reducer<LongWritable, BytesWritable, Text, LongWritable>{
	private LongWritable sumWritable = new LongWritable(10);
	String filename;
	private final static Log LOG = LogFactory.getLog(HMReducerPath2.class);
